              ...
              <div className="relative">
                ...
                <div className="relative group">
                  <div className="p-4 bg-zinc-900/50 rounded-lg border border-white/10 group-hover:border-white/20 transition-colors">
                    ...
                    <code>
  <span className="text-purple-400">getgenv</span>()<span className="text-blue-300">ignoreGameCheck</span> <span className="text-gray-400">=</span> <span className="text-red-400">false</span>
