...
const UpdateNotification = ({ version = '0' }: UpdateNotificationProps) => {
  ...
  const cookieName = `update-notification-${version}`;
  ...
  return (
    <div className="fixed top-32 left-1/2 -translate-x-1/2 z-40 w-full max-w-6xl px-4">
      <div className="rounded-2xl border-2 border-white/10 bg-black/40 backdrop-blur-xl shadow-2xl ring-1 ring-white/5 ring-offset-0">
        <div className="px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-x-3">
              <div className="w-1.5 h-1.5 bg-accent rounded-full animate-pulse" />
              <p className="text-sm text-gray-300">
                A new software update is available. See what`&apos;s new in version {version}
              </p>
            </div>
